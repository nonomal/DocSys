...
//   @ComponentScan  -> replaced by <context:component-scan base-package="com.docsys.agent"/>
...
public class DocSysAgentApplication {
    ...
    public MainAgent mainAgent(DocSysClient docSysClient, LLMService llmService,
            com.docsys.agent.learning.service.CollaborativeFilteringService learningService,
            com.docsys.agent.learning.service.BehaviorTrackingService behaviorTrackingService,
            com.docsys.agent.evolution.EvolutionTrigger evolutionTrigger) {
     ...
     * {@link com.docsys.agent.config.DocSysSelfDiscovery}). The agent WAR
