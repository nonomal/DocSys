...
MxsDoc是一个内置 **AI智能体** 和 **Office引擎** 的文档管理软件，支持文档分级/分类/版本管理、Office预览/编辑、WPS预览/编辑、在线解压缩、文件分享、文件加密、远程存储、远程推送、智能搜索、在线笔记、本地自动备份、异地自动备份、回收站、一键迁移、集群部署。

主要应用场景：AI知识库、AI智能体、文档管理系统、协同办公系统、在线笔记、电子书、软件接口管理系统、自动备份软件、网页版SVN仓库、网页版GIT仓库、FTP客户端、SFTP客户端、SMB客户端、Linux系统远程文件访问。
